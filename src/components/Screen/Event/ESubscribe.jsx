...
const ESubscribe = () => {
  return (
    <section className="mt-10 md:mt-20">
      <div className="bg-amber-400 text-zinc-500 text-[0.94rem] md:leading-5 rounded-lg p-5 sm:p-6 lg:p-12">
        <div className=" relative">
          <div className="px-3.5">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
              <div className="">
                <h3 className="text-white text-[1.5rem] lg:text-3xl font-bold mb-2">Are you ready for next great Events?</h3>
              </div>
