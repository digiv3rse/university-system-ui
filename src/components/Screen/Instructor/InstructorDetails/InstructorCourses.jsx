    ...
    <div>
      <div className="">
        <div className="text-zinc-500 text-[0.94rem] leading-5">
          <div className="h-full bg-white rounded-lg shadow-3xl">
            <img
            ...
            <div className="flex-grow px-5 pt-4">
              ...
              <h5 className="text-zinc-800 text-[1.31rem] leading-7 font-medium mb-2 hover:text-primary-600 duration-300 ease-in-out">
