          ...
          <ul>
            ...
            <li className="text-zinc-800 inline-block font-bold mr-4">
              <svg
                ...
                height="18"
                viewBox="0 0 448 512"
                className="text-orange-500 inline-block mr-2 -mt-1"
              >
                <path
                  fill="currentColor"
            ...
            <li className="text-zinc-800 inline-block font-bold mr-4">
              <svg
                ...
                className="text-emerald-500 inline-block mr-2 mt-2"
              >
            ...
            <li className="text-zinc-800 inline-block font-bold mr-4">
              <svg
                ...
                className="text-rose-600 inline-block mr-2 -mt-1"
              >
                <path
                  fill="currentColor"
            ...
            <li className="text-zinc-800 inline-block font-bold">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="text-cyan-600 inline-block mr-2 -mt-1">
                <path
                  fill="currentColor"
