...
const Overview = () => {
  return (
    <div>
      <div className="text-zinc-500 text-[0.94rem] leading-5 break-words py-8 px-5">
        <div>
          <h5 className="text-zinc-800 text-[1.31rem] leading-7 font-bold mb-4">Course Description</h5>

          <p className="mb-4">
            Welcome to the{" "}
            <strong className="font-bold"> Digital Marketing Ultimate Course Bundle - 12 Courses in 1 (Over 36 hours of content)</strong>
          </p>

          <p className="mb-4">
            In this practical hands-on training, you’re going to learn to become a digital marketing expert with this{" "}
            <strong className="font-bold"> ultimate course bundle that includes 12 digital marketing courses in 1!</strong>
          </p>
          ...
          <h5 className="text-zinc-800 text-[1.31rem] leading-7 font-bold mb-2 mt-6">What you’ll learn</h5>

          <ul className="flex flex-col list-disc mb-4 rounded-md">
            <li className="rounded-tl-md rounded-tr-md flex py-1.5">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 48 48" className="inline-block mr-2">
                ...
                <path fill="#0cbc87" d="M0 0h48v48H0z" mask="url(#ipSCheckOne0)" />
              </svg>
