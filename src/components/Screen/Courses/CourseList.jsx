...
const CourseList = ({ course }) => {
  const { name, imageSrc, rating, level, hours, minute, lectures } = course;
  return (
      ...
      <div className="h-full bg-white flex flex-col break-words rounded-lg shadow-3xl">
        ...
        <div className="flex-grow px-5 pt-4">
          <div className="flex justify-between mb-2">
            <a className="bg-violet-700/[0.1] text-violet-700 cursor-pointer text-[0.80rem] py-1 px-2 text-center rounded-md" href="#">
              {level}
            </a>
          ...
          <StarSVG className="items-center flex justify-start mb-4" rating={rating} />
        </div>
        <hr className="my-4" />
